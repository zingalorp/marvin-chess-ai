...
from model_v2 import ChessformerV2, CONFIG_V2_LEELA, CONFIG_V2_DEEP, CONFIG_V2_SMOLGEN
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--val-interval", type=int, default=10000, help="Run validation every N optimizer steps")
    parser.add_argument("--val-batches", type=int, default=1000, help="Max batches per validation run (0 for full)")
